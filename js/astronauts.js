function html_card(title="",desc="",date="",img="",size="normal") {
        ...
        <div style="grid-column: 1; grid-row: 2;">
            ...
            <div class="history_card_description">
                <div style="height: 10px; display: grid; grid-template-columns: 1fr 1fr 4fr;">
                    ...
                    <p style="grid-column: 2; margin-left: 30px; margin-right: 30px; margin-top: 7px; font-size:105%; text-wrap: nowrap;"><b>${date}</b></p>
...
window.onload = function() {
    ...
    const cards = ["uri", "amstrong",,"frank","zigmyt","harison","alex","leon","titov","ter"].reverse()
