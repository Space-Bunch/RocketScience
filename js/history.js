        ...
        <div style="grid-column: 1; grid-row: 2;">
            ...
            <div class="history_card_description">
                <div style="height: 10px; display: grid; grid-template-columns: 1fr 1fr 4fr;">
                    ...
                    <p style="grid-column: 2; margin-left: 30px; margin-right: 30px; margin-top: 7px; text-wrap: nowrap;">
                        <button class="static purpule" popovertarget="${json+'_sourse'}"><b style="${get_font_size()}">${title}</b></button>
                    </p>
